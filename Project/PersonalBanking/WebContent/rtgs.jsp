...
<form method="post" action="http://172.17.111.142:8085/PersonalBanking/rtgsfundtransfercontroller2.jsp">
<h1 id="fundtransferheader">RTGS Fund Transfer</h1>
...
<INPUT TYPE="number" name="amount" id="amount" autocomplete="off" class="input"  min=200001 max=1000000><BR><BR><BR>
